...
Thank you for your interest in contributing to [microsoft-agent-framework-workshop](https://github.com/dileepadev/microsoft-agent-framework-workshop)! We welcome contributions, including bug fixes, feature enhancements, documentation improvements, and other general improvements.
...
1. **Fork the repository**  
   ...
   To fork the repository, click the **Fork** button in the top right corner of this page or click [here to fork the repository](https://github.com/dileepadev/microsoft-agent-framework-workshop/fork).
...
- Refer to the following templates and guidelines before submitting your changes:
  - [microsoft-agent-framework-workshop/](./) - Root directory of the repository
